	...
	return (
		<div className="absolute inset-0 z-10 text-white bg-black bg-opacity-40">
			<div className="flex space-y-6 h-full flex-col px-5 py-[120px] justify-end items-center">
				...
				<p className="text-lightGray w-[65%] lg:w-[40%] md:py-4 md:landscape:py-2 lg:py-6 text-lg md:text-3xl md:landscape:text-3xl lg:text-4xl text-center leading-8 font-[300]">
